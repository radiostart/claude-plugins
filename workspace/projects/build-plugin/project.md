...
- [ ] pilot-update.sh 고장 — 경로 stale + 설계 한계 + 잘못된 안내 -> [상세](features/24-pilot-update-tool.md) `[후속]` (evaluator 2026-07-26: spec 기대결과 (C) 4곳 중 v0.10.0 릴리스 노트 1곳 미정정 — 저장소 내 전건은 통과. 전달사항 마지막 행 참조)

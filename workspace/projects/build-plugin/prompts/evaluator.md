...
- [ ] #23 `check_conventions_paths` 파서 수정으로 config 표 플레이스홀더 오탐 제거 — doctor WARN 4 → 2. 정상 미선언 케이스 WARN 유지 + 기존 doctor 테스트 무손.

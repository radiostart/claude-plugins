...
- [ ] #21 reference/index.md 도구 목록에서 삭제 3종 제거 + how-to/doctor-migration.md 현행화 (마이그레이션 절차 제거·--fix/--diagnose 현행 거동 반영·파일명 보존으로 인바운드 링크 5곳 무손) + docs_build --check·test_doc_links 통과 + md 외 변경 0.

...
| #24 update 도구 | ✅ **READY** | D1 = **(iii) 폐기** 실행 — `pilot-update.sh` 삭제 + README·getting-started·release-and-upgrade 안내 정정. `README.md:35` 설치 명령 id 오류(신규 설치 실패)도 함께 해소. v0.10.0 릴리스 노트 `## 업그레이드` 블록도 사용자 승인 후 정정 완료 (백업·diff 검증 이행). 커밋 `b4e73e3`·`f0f01d5`·`798c799`·`a149968` |
...
6. ~~**#24 사이클**~~ — **완료** (2026-07-26, 브랜치 `skills/24-pilot-update-tool`). `pilot-update.sh` 는 **삭제됐다 — 되살리지 말 것**. 배포된 v0.10.0 릴리스 노트도 정정됐다.

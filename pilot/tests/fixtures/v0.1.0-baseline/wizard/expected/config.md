...
| ---- | ---- |
| `.git/` | wizard baseline |
| `node_modules/` | wizard baseline |
| `__pycache__/` | wizard baseline |
| `vendor/` | wizard baseline |
| `dist/` | wizard baseline |
| `build/` | wizard baseline |
| `.next/` | wizard baseline |
| `target/` | wizard baseline |
| `*.pyc` | wizard baseline |
| `*.lock` | wizard baseline |

...
LLM 시뮬레이션 캡처 특성상 유지보수 비용만 발생했다 (repo 루트 `docs/audits/2026-07-24-pilot-consolidation-audit.md` § 3).
...
근거: repo 루트 `docs/audits/2026-07-24-audit-4-python.md` § C). 이 디렉터리 아래 이제
`_input/` 만 남는다.
